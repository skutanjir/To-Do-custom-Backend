...
class CreativeWritingExpert implements ExpertInterface
{
    ...
    private function generateStory(string $msg, string $lang, string $userName): string
    {
        ...
        $stories = [
            ...
            'horror' => [
                ['id' => "Rumah tua di ujung jalan itu sudah lama kosong. Tapi malam ini, {$userName} mendengar suara piano dari dalam. Pintunya terbuka sendiri, dan di ruang tamu, ada boneka porcelain yang belum pernah ada sebelumnya. Matanya mengikuti {$userName} ke mana pun berjalan. Dan di cermin... refleksi {$userName} tersenyum, padahal {$userName} tidak... 👻🏚️", 'en' => "The old house at the end of the street had been empty for years. But tonight, {$userName} heard piano music from inside. The door opened by itself, and in the living room sat a porcelain doll that wasn't there before. Its eyes followed {$userName} everywhere. And in the mirror... {$userName}'s reflection was smiling, though {$userName} was not... 👻🏚️"],
            ...
            'mystery' => [
                ['id' => "Lima undangan emas dikirim ke lima orang, termasuk {$userName}. 'Datanglah ke Pulau Bayangan. Hadiah: 1 miliar.' Satu per satu tamu mulai menghilang. Petunjuk tersebar di seluruh pulau. {$userName} menyadari: ini bukan permainan — ini ujian. Dan orang yang mengirim undangan itu... mungkin ada di antara mereka. 🔍🏝️", 'en' => "Five golden invitations were sent to five people, including {$userName}. 'Come to Shadow Island. Prize: 1 billion.' One by one, guests began disappearing. Clues were scattered across the island. {$userName} realized: this wasn't a game — it was a test. And the person who sent the invitations... might be among them. 🔍🏝️"],
            ],
            'scifi' => [
    ...
    {
        $prompts = [
            ['id' => "✍️ **Prompt Menulis**: Kamu menemukan surat dari dirimu sendiri 10 tahun ke depan. Isinya hanya satu kalimat. Apa isinya dan apa yang kamu lakukan setelah membacanya?", 'en' => "✍️ **Writing Prompt**: You find a letter from yourself 10 years in the future. It contains only one sentence. What does it say, and what do you do after reading it?"],
            ['id' => "✍️ **Prompt Menulis**: Suatu hari, semua orang di dunia kehilangan satu kemampuan yang mereka anggap remeh. Kemampuan apa itu, dan bagaimana dunia berubah?", 'en' => "✍️ **Writing Prompt**: One day, everyone in the world loses one ability they took for granted. What ability is it, and how does the world change?"],
            ['id' => "✍️ **Prompt Menulis**: Kamu bangun dan menemukan bahwa kamu bisa mendengar pikiran hewan. Apa yang hewan peliharaanmu pikirkan tentangmu?", 'en' => "✍️ **Writing Prompt**: You wake up and find you can hear animals' thoughts. What does your pet think about you?"],
            ['id' => "✍️ **Prompt Menulis**: Di lemari tua nenek, kamu menemukan pintu kecil yang belum pernah kamu lihat. Ke mana pintu itu membawa kamu?", 'en' => "✍️ **Writing Prompt**: In your grandmother's old wardrobe, you find a tiny door you've never seen before. Where does it lead?"],
            ['id' => "✍️ **Prompt Menulis**: Tulis percakapan antara matahari dan bulan saat mereka bertemu saat gerhana.", 'en' => "✍️ **Writing Prompt**: Write a conversation between the sun and the moon when they meet during an eclipse."],
            ['id' => "✍️ **Prompt Menulis**: Kamu adalah robot terakhir di bumi. Semua manusia sudah pergi. Tulis catatan harianmu.", 'en' => "✍️ **Writing Prompt**: You are the last robot on Earth. All humans are gone. Write your diary entry."],
        ];
